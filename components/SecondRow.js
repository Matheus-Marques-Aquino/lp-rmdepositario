...
export default function SecondRow({ updateSelect }) {
  ...
  const CardArray = [
    {
      url: [
        "/imgs/persianas/rolo-screen-1.png",
        "/imgs/persianas/rolo-screen-4.png",
      ],
    ...
    {
      url: [
        "/imgs/persianas/rolo-blackout-1.png",
        "/imgs/persianas/rolo-blackout-2.png",
      ],
    ...
    {
      url: [
        "/imgs/persianas/double-vision-2.png",
        "/imgs/persianas/double-vision-1.png",
      ],
    ...
    {
      url: [
        "/imgs/persianas/horizontal-1.png",
        "/imgs/persianas/horizontal-2.png",
      ],
